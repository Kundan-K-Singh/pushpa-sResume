...
\cvjobtitle{Research Associate\\{\large(Currently on Notice Period)}} % Job title/career
...
\begin{twenty} % Environment for a list with descriptions
	\twentyitem{2021-2022}{\emph{MedGenome Labs Limited}}{Full Time}
	...
	$\bullet$ Data analysis using bluefuse multi\\
